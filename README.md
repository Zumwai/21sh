...
* Подрехтовать парсер строки при чтении, экранирование конфликтует с имеющимися настройками
...
**Автозаполнение:**
* Некрасивоотображает множественные варианты:
* Понимание контекста барахлит, выполняется на ~70%.
